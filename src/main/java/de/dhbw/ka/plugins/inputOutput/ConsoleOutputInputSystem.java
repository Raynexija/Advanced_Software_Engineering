package de.dhbw.ka.plugins.inputOutput;

import de.dhbw.ka.adapter.textBased.TextBasedOutputInputSystem;
...
public class ConsoleOutputInputSystem implements TextBasedOutputInputSystem {
    ...
    public ConsoleOutputInputSystem(OutputStream output, InputStream input) {
